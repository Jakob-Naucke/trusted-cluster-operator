...
// kopium command: kopium virtualmachines.kubevirt.io -A --no-condition --derive Default
...
#[kube(group = "kubevirt.io", version = "v1", kind = "VirtualMachine", plural = "virtualmachines")]
#[kube(namespaced)]
...
pub struct VirtualMachineTemplateSpecAccessCredentialsSshPublicKeyPropagationMethod {
    ...
    pub config_drive: Option<VirtualMachineTemplateSpecAccessCredentialsSshPublicKeyPropagationMethodConfigDrive>,
    ...
    pub qemu_guest_agent: Option<VirtualMachineTemplateSpecAccessCredentialsSshPublicKeyPropagationMethodQemuGuestAgent>,
}
...
pub struct VirtualMachineTemplateSpecAccessCredentialsUserPasswordPropagationMethod {
    ...
    /// This feature requires the qemu guest agent to be running within the guest.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "qemuGuestAgent")]
    pub qemu_guest_agent: Option<VirtualMachineTemplateSpecAccessCredentialsUserPasswordPropagationMethodQemuGuestAgent>,
}
...
pub struct VirtualMachineTemplateSpecDomainDevicesInterfacesDhcpOptions {
    ...
    pub private_options: Option<Vec<VirtualMachineTemplateSpecDomainDevicesInterfacesDhcpOptionsPrivateOptions>>,
...
pub struct VirtualMachineTemplateSpecTopologySpreadConstraintsLabelSelector {
    /// matchExpressions is a list of label selector requirements. The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchExpressions")]
    pub match_expressions: Option<Vec<VirtualMachineTemplateSpecTopologySpreadConstraintsLabelSelectorMatchExpressions>>,
    /// matchLabels is a map of {key,value} pairs. A single {key,value} in the matchLabels
    /// map is equivalent to an element of matchExpressions, whose key field is "key", the
    /// operator is "In", and the values array contains only "value". The requirements are ANDed.
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "matchLabels")]
...
pub struct VirtualMachineTemplateSpecVolumesCloudInitConfigDrive {
    ...
    pub network_data_secret_ref: Option<VirtualMachineTemplateSpecVolumesCloudInitConfigDriveNetworkDataSecretRef>,
...
pub struct VirtualMachineTemplateSpecVolumesCloudInitNoCloud {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "networkDataSecretRef")]
    pub network_data_secret_ref: Option<VirtualMachineTemplateSpecVolumesCloudInitNoCloudNetworkDataSecretRef>,
...
pub struct VirtualMachineStatus {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "desiredGeneration")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "memoryDumpRequest")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "preferenceRef")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "snapshotInProgress")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "stateChangeRequests")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "volumeSnapshotStatuses")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "volumeUpdateState")]
...
pub struct VirtualMachineStatusInstancetypeRef {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "controllerRevisionRef")]
...
pub struct VirtualMachineStatusStartFailure {
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "consecutiveFailCount")]
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "retryAfterTimestamp")]
...
pub struct VirtualMachineStatusVolumeRequests {
    ...
    /// within this field specify how to add the volume
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "removeVolumeOptions")]
...
pub struct VirtualMachineStatusVolumeRequestsAddVolumeOptionsVolumeSource {
    ...
    /// More info: <https://kubernetes.io/docs/concepts/storage/persistent-volumes#persistentvolumeclaims>
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "persistentVolumeClaim")]
    pub persistent_volume_claim: Option<VirtualMachineStatusVolumeRequestsAddVolumeOptionsVolumeSourcePersistentVolumeClaim>,
}
...
pub struct VirtualMachineStatusVolumeUpdateState {
    ...
    #[serde(default, skip_serializing_if = "Option::is_none", rename = "volumeMigrationState")]
...
pub struct VirtualMachineStatusVolumeUpdateStateVolumeMigrationState {
    ...
    pub migrated_volumes: Option<Vec<VirtualMachineStatusVolumeUpdateStateVolumeMigrationStateMigratedVolumes>>,
}
...
pub struct VirtualMachineStatusVolumeUpdateStateVolumeMigrationStateMigratedVolumes {
    ...
    pub destination_pvc_info: Option<VirtualMachineStatusVolumeUpdateStateVolumeMigrationStateMigratedVolumesDestinationPvcInfo>,
    ...
    pub source_pvc_info: Option<VirtualMachineStatusVolumeUpdateStateVolumeMigrationStateMigratedVolumesSourcePvcInfo>,
